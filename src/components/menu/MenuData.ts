import matchaLatteDefault from "@/assets/menu/matcha-latte-default.webp";
const pureImg = matchaLatteDefault;
const honeyImg = matchaLatteDefault;
const vanillaSilkImg = matchaLatteDefault;
import strawberryImg from "@/assets/menu/strawberry.webp";
import blueberryImg from "@/assets/blueberry-vanilla-matcha.webp";
import raspberryImg from "@/assets/menu/raspberry.webp";
import mangoImg from "@/assets/menu/mango.webp";
import caramelToffeeImg from "@/assets/menu/caramel-toffee.webp";
import bananaPuddingImg from "@/assets/menu/banana-pudding.webp";
import cookieButterImg from "@/assets/menu/cookie-butter.webp";
import rosyRoseImg from "@/assets/menu/rosy-rose.webp";
import peachCobblerImg from "@/assets/menu/peach-cobbler.webp";
import vanillaSoftServeImg from "@/assets/menu/vanilla-soft-serve.webp";
import strawberrySoftServeImg from "@/assets/menu/strawberry-soft-serve.webp";
