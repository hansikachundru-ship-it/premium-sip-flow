      ...
      {sections.map((item) => (
        ...
        >
          ...
          >
            ...
            <h2 className="font-display text-crimson text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-extrabold uppercase tracking-wide mb-3 sm:mb-4">
              {item.title}
            </h2>
            <p className="font-body text-charcoal/70 text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed mb-4 sm:mb-5 text-justify">
              {item.desc}
            </p>
            <ul className="font-body text-charcoal/70 text-sm sm:text-base md:text-lg lg:text-xl space-y-1.5 sm:space-y-2 mb-4 sm:mb-6 max-w-md">
            ...
            <a
              ...
              className="inline-block border-2 border-crimson text-crimson font-display text-sm sm:text-base md:text-lg font-bold uppercase tracking-widest px-5 sm:px-6 py-2.5 sm:py-3 hover:bg-crimson hover:text-blush transition-colors w-fit"
            >
              {item.cta}
            </a>
          </motion.div>
