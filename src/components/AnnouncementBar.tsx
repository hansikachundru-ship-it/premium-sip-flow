...
const messages = [
  "India's 1st Premium Matcha & Cafe Chain",
...
const AnnouncementBar = () => {
  ...
  return (
    <div className="bg-crimson text-blush py-2.5 px-4 relative flex items-center justify-center gap-3">
      <button
      ...
      <span
        className="text-center font-medium tracking-wide text-xs md:text-sm italic"
