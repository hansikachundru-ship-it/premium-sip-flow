    ...
    <div className="min-h-screen" style={{ backgroundImage: `url(${patternBlushLight})`, backgroundSize: "300px", backgroundColor: "hsl(var(--blush))" }}>
      ...
      <main>
        ...
        <div className="text-center py-6 sm:py-8 md:py-12 px-4">
          ...
          <p className="text-xs sm:text-sm md:text-base lg:text-lg text-crimson/60 mt-2 sm:mt-3 font-body font-normal tracking-wide">
          ...
          <AnimatePresence mode="wait">
            ...
            {activeTab === "soft" && (
              <MenuCard
                ...
                footer={
                  <div className="mt-4 sm:mt-6 px-4 sm:px-5 py-2.5 sm:py-3 bg-blush rounded-xl border border-matcha/40 text-center shadow-sm">
                    <p className="text-xs sm:text-sm font-bold text-matcha-dark font-display">Matcha Affogato – Add On @ ₹80</p>
                    <p className="text-[10px] sm:text-xs text-matcha-dark font-body mt-1" style={{ fontFamily: "var(--font-handwriting)" }}>
